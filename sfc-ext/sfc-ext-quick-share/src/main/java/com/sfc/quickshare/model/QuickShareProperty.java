...
public class QuickShareProperty {
    ...
    @ConfigProperties(describe = "开启快速分享功能", title = "功能开关", inputType = "switch", defaultValue = "true")
    private Boolean isEnabled = Boolean.TRUE;

    @ConfigProperties(describe = "最大文件限制（MiB)", title = "最大文件限制", defaultValue = "512")
    private Long maxSize = 512L;

    @ConfigProperties(describe = "单位：分钟，文件到期后将被自动清理", title = "文件保留时长", defaultValue = "30")
