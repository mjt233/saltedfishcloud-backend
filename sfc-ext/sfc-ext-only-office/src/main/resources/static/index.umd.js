...
`;return(d,a)=>(t.openBlock(),t.createElementBlock("div",null,[t.createVNode(t.unref(r.MarkdownView),{content:i})]))}}),m=[".docx",".doc",".xlsx",".xls",".ppt",".pptx",".pdf",".hwp",".wps",".html",".odt"];function f(c,i,d,a){return{id:a,icon:d,title:c,matcher(n,l){return!i&&n.readonly?!1:m.findIndex(s=>l.name.endsWith(s))!=-1},sort:o.getContext().fileOpenHandler.value.length,action(n,l){const s={targetId:n.uid,path:n.path,protocol:n.protocol,isView:i||n.readonly,...n.getProtocolParams(),name:l.name},O=`${location.origin}/api/office/editor?${e.stringify(s)}`;window.open(O)}}}window.bootContext.addProcessor({taskName:"注册文档组件",execute(c,i){o.getContext().fileOpenHandler.value.push(f("文档在线编辑",!1,"mdi-file-document-edit","only-office-edit")),o.getContext().fileOpenHandler.value.push(f("文档在线预览",!0,"mdi-file-eye-outline","only-office-view")),c.component("OnlyOfficeHelp",u)}})});
