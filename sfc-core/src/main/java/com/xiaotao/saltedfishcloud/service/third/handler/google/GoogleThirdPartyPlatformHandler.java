...
public class GoogleThirdPartyPlatformHandler extends AbstractThirdPartyPlatformHandler<GooglePlatformProperty> {
    ...
    @Autowired
    public GoogleThirdPartyPlatformHandler(ProxyInfoService proxyInfoService, AttachStorageManager attachStorageManager) {
        super(proxyInfoService, attachStorageManager);
    }
