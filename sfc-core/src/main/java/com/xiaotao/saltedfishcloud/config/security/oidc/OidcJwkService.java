...
/**
 * OIDC JWK 服务，负责生成用于 JWT 令牌签名的 RSA 密钥集。
 * <p>
 * 当前实现在每次调用 {@link #generateJwkSet(OidcServerProperty)} 时生成新的 2048 位 RSA 密钥对。
...
public class OidcJwkService {
     ...
     * 注意：每次调用均生成全新密钥对，不会从持久化存储中加载已有密钥。
     * </p>
     *
     ...
     */
    public JWKSet generateJwkSet(OidcServerProperty property) {
        try {
