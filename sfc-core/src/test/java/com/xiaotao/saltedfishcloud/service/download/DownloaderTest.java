...
class DownloaderTest {
    ...
    public void testCallback() throws InterruptedException {
        ...
        AsyncDownloadTaskImpl t = builderFactory.getBuilder().setUrl(url).build();
        TaskContext<AsyncDownloadTaskImpl> context = factory.createContextFromAsyncTask(t);
    ...
    public void testProxy() {
        ...
        AsyncDownloadTaskImpl t = builderFactory.getBuilder().setUrl(url)
    ...
    public void testDownload() throws InterruptedException {
        ...
        AsyncDownloadTaskImpl t = builderFactory
                .getBuilder()
                .setUrl(url)
                .setSavePath("D:\\a.exe")
                .build();

        TaskContextFactoryImpl factory = new TaskContextFactoryImpl(new TaskManagerImpl());
        TaskContext<AsyncDownloadTaskImpl> context = factory.createContextFromAsyncTask(t);
        factory.getManager().submit(context);
