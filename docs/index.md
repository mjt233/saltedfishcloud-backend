...
具有支持代理的离线下载，FTP/WebDAV访问，在线解压缩，文件搜索，文件收集，文件/目录分享，OSS对象存储挂载等功能。
> 部分功能由插件提供，见[在线文档](https://mjt233.github.io/saltedfishcloud-backend)的插件列表
...
| S3 OSS | sfc-ext-oss-store    |

目前支持外部访问的协议见下表：

| 协议     | 拓展名称               |
|--------|--------------------|
| FTP    | sfc-ext-ftp-server |
| WebDAV | sfc-ext-webdav     |
